...
<template>
  <footer class="version">
    <a class="mr-2" target="_blank" href="https://github.com/glennliao/bookmark"><svg t="1686376535417" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                                      p-id="2370" width="16" height="16"><path
      ...
      fill="#444444" p-id="2371"></path></svg></a>
