module github.com/glennliao/bookmark

go 1.18

require (
	github.com/PuerkitoBio/goquery v1.8.1
	github.com/glennliao/apijson-go v0.2.0-beta4
...
replace github.com/glennliao/apijson-go v0.2.0-beta4 => ../apijson/apijson-go
